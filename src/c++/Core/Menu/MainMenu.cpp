...
namespace Core::Menu
{
    void MainMenuEx::ProcessEx(RE::GPtr<RE::GFxMovieView> a_movie)
    {
        ...
        {
            SKSE::log::warn("MainMenuEx: No _root");
            return;
        }
        ...
        {
            SKSE::log::warn("MainMenuEx: No _root.MenuHolder");
            return;
        }
        ...
        {
            SKSE::log::warn("MainMenuEx: No _root.MenuHolder.Menu_mc");
            return;
        }
        ...
        if (!config.UI.Logo)
        {
            ...
            {
                SKSE::log::warn("MainMenuEx: No _root.MenuHolder.Menu_mc.Logo_mc");
            }
        }
        ...
        if (!config.UI.Motd)
        {
            ...
            {
                SKSE::log::warn("MainMenuEx: No _root.MenuHolder.Menu_mc.MessageOfTheDay_mc");
            }
        }
        ...
        if (menuMC.GetMember("MainList", &mainList))
        {
            ...
            {
                SKSE::log::warn("MainMenuEx: Could not invoke _root.MenuHolder.Menu_mc.MainList.__get__entryList()");
            }
        }
        else
        {
            SKSE::log::warn("MainMenuEx: No _root.MenuHolder.Menu_mc.MainList");
        }
